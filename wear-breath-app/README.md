...
This application provides a simple breath Activity.
...
- Expand the `wear-breath-app` item,
- From the nested `Tasks` list, expand the `microej` item,
- Double-click on `runOnSimulator`,
- The Simulator starts, the traces are visible in the Run view.

To open the Breath app:

- Click any button of the watch to open the application launcher,
- Tap Breath icon to open the app.

To quit the Breath app:

- Click any button of the watch to return to the current watchface or to leave breathing timer.
