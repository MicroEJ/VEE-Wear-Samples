...
public class VectorCircularProgressBar extends Widget {
	...
	private void createCircleArc() {
		...
		CircleArc.CircleArcBuilder builder = style.getExtraObject(VectorCircularProgressBar.CIRCLE_ARC_STYLE,
		...
		builder = style.getExtraObject(VectorCircularProgressBar.BACKGROUND_CIRCLE_ARC_STYLE,
				CircleArc.CircleArcBuilder.class, CircleArc.CircleArcBuilder.DEFAULT_BUILDER);
