 ...
 */
package com.microej.example.wear.stopwatch;
 ...
 */
public class StopwatchAppEntryPoint implements FeatureEntryPoint {

	@Override
	public void start() {
		ComponentService componentService = KernelServiceProvider.getComponentService();
		componentService.registerActivity(new StopwatchActivity());
	}
