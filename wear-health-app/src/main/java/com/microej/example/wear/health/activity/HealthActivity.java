...
/**
 * {@link Activity} which shows health information.
 */
public class HealthActivity implements Activity {

	private static final String ICON_IMAGE_135 = "/images/ic_health_135px.png";
	private static final String ICON_IMAGE_314 = "/images/ic_health_314px.png";

	private final Image iconImage135;
	private final Image iconImage314;

	/**
	 * Creates a health activity.
	 */
