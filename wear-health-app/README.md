...
The VEE Wear Health application provides:

- an Activity which shows health information.
- Complication Data Sources for steps, heart rate, calories and SpO2.
